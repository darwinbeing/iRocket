...
// Freedom E200 HBird Kit Peripherals
class E200HBirdKitPeripherals extends Config((site, here, up) => {
...
// Freedom E200 HBird Kit Peripherals
class E200HBirdKitConfig extends Config(
  new E200HBirdKitPeripherals    ++
